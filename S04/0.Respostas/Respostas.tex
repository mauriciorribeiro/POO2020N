...
\section*{Questão 2:}
\lstinputlisting[language=C++, firstline=1]{../2.arranjo/src/arranjo_array.cpp}
\begin{figure}[h!]
...
\section*{Questão 3:}
\lstinputlisting[language=C++, firstline=1]{../3.dados/src/main.cpp}
\begin{figure}[h!]
...
\section*{Questão 4:}
\lstinputlisting[language=C++, firstline=1]{../4.reservas/src/main.cpp}
\begin{figure}[h!]
